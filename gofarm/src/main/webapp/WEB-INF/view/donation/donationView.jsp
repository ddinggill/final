					...
					<table class="goods-view-form-table">
						<tbody>
							...
							<tr>
								...
								<td class="goods-view-form-table-cell">${do_dto.do_cnt} 개</td>
							</tr>
							<tr>
								<th scope="row" class="goods-view-form-table-heading">판매자</th>
								<td class="goods-view-form-table-cell"><!-- 판매자 유저코드로 이름을 가져온다 --></td>
							</tr>

						</tbody>
					</table>
					<c:url var="path" value="donationPay.do">
						<c:param name="prod_code" value="${do_dto.docode}" />
					</c:url>
