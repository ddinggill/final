                  ...
                  <div class="dplay-tbl">
                     <div class="dplay-tbl-cell">
                        <form class="form-block form-brdr-b mx-w-400x m-auto">
                           <span class="color-white ptb-15 center-sm-text" style="color:white">gofarm16@gmail.com </span>
                           <span class="mt-30 btn-brdr-grey color-ash w-100 text-center">Go Farm</span>
