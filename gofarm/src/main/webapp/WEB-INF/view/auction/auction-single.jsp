    ...
    $.ajax({   
       ...
       success : function(res){
          if(res){
             ...
             alert("현재 마일리지보다 높은 입찰금액은 불가능합니다.");
             returnval = false;
          } 
       },
       error: function(){
...
<body class="goto-here">
   ...
   <section class="ftco-section">
      <div class="container">
         <div class="row">
            <div class="col-lg-6 mb-5 ftco-animate bod"  >
               <a href="/gofarm/profileUpload/${dto.au_file}" class="image-popup" >
               <img src="/gofarm/profileUpload/${dto.au_file}" class="img-fluid"
                  alt="Colorlib Template" style="height:400px; width: 470px;"></a>
            </div>
            ...
            <div class="">
               ...
               <table class="">
                  ...
                  <tr>
                        ...
                        <td class="goods-price2">₩ ${dto.stprice}</td>
                     </tr>
...
<hr>                      <tr>
                        ...
                        <td class="goods-view-form-table-cell"><div
                              ...
                              <span class="input-group-btn mr-2">
                                 ...
                                 class="form-control input-number" value="${dto.ctprice}" 
                     ...
                     <tr>
                        <td><input type="hidden" value="${dto.fin_time}" id="end"></td>
                        <td>   
                          <c:if test="${dto.state eq 0}">
                           <input type="submit" class="btn btn-black py-3" value="입찰하기" id="bidding"
                             style="width:50%; margin-top:20px!important" >
                        </c:if>
                  ...
                  <tr>
                        ...
                        <td id="timetable"  style="font-weight:bolder;font-size:40px;"><script type="text/javascript">timecount();</script> </td>
                     </tr>
                     <tr>
