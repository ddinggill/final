      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">상품</a></span> <span>등록페이지</span></p>
            <h1 class="mb-0 bread">상 품 등 록</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row block-9">
          <div class="col-md-12 order-md-last d-flex">
            <form action="productProducePro.do"  class="bg-white p-5 contact-form"  enctype="multipart/form-data" method="post" >
